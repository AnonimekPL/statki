...
void gra::strzal(plansza* moja, plansza* przeciwnika, ekran* ekran, gracz* gracz)
{
	...
	} while (przeciwnika->getTab()[x][y] != "X" and przeciwnika->getTab()[x][y] != "O");
	while (przeciwnika->getTab()[x][y] == "X" and przeciwnika->getIlosc_pol() > 0)
	{

		przeciwnika->setIlosc_pol(przeciwnika->getIlosc_pol() - 1);
		moja->setTab_pomocnicza(x, y, "T");
		przeciwnika->setTab(x, y, "T");
		system("cls");
		ekran->rysuj(moja);
		cout << przeciwnika->getIlosc_pol();
		if (przeciwnika->getIlosc_pol() > 0)
		{
	...
	moja->setTab_pomocnicza(x, y, "N");
	przeciwnika->setTab(x, y, "N");
...
void plansza::setTab(int x, int y, const string& value) { tab[x][y] = value; }
void plansza::setTab_pomocnicza(int x, int y, const string& value) { tab_pomocnicza[x][y] = value; }
...
void ekran::rysuj(plansza* plansza1)
{
	...
	for (int i = 0; i < plansza1->get_Do_plansza() + 1; i++)
	{
		...
		{
			if (plansza1->getTab()[i][j] == "X")
				SetConsoleTextAttribute(hConsole, 14);
			else if (plansza1->getTab()[i][j] == "N")
				SetConsoleTextAttribute(hConsole, 6);
			else if (plansza1->getTab()[i][j] == "O")
				SetConsoleTextAttribute(hConsole, 8);
			else if (plansza1->getTab()[i][j] == "T")
				SetConsoleTextAttribute(hConsole, 4);
			cout << plansza1->getTab()[i][j] << " ";
			SetConsoleTextAttribute(hConsole, 15);
		}
		if (i == 0)
			cout << " " << "\t";
		...
		for (int j = 0; j < plansza1->get_Do_plansza() + 1; j++)
		{
			if (plansza1->getTab_pomocnicza()[i][j] == "X")
				SetConsoleTextAttribute(hConsole, 14);
			else if (plansza1->getTab_pomocnicza()[i][j] == "N")
				SetConsoleTextAttribute(hConsole, 6);
			else if (plansza1->getTab_pomocnicza()[i][j] == "O")
				SetConsoleTextAttribute(hConsole, 8);
			else if (plansza1->getTab_pomocnicza()[i][j] == "T")
				SetConsoleTextAttribute(hConsole, 4);
			cout << plansza1->getTab_pomocnicza()[i][j] << " ";
			SetConsoleTextAttribute(hConsole, 15);
		}
		cout << endl;
	}
...
int statek::getX1() { return x1; }
int statek::getY1() { return y1; }
int statek::getX2() { return x2; }
int statek::getY2() { return y2; }
int statek::getRozmiar() { return rozmiar; }
